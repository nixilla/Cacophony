...
<p>You are logged in as <?php echo $sf_user->getGuardUser()->getUsername() ?: $sf_user->getGuardUser()->getFirstName(); ?> using provider: <?php echo ucfirst($sf_user->getCurrentProvider()); ?></p>
<?php endif; ?>
...
<ul>
  ...
  <?php if($sf_user->getCurrentProvider() == 'netflix'): ?><li><?php echo link_to('See what you can do with Netflix','demo/netflix'); ?></li><?php endif; ?>
  <?php else: ?>
  ...
  <li><?php echo link_to('Login with Netflix','@sf_cacophony_connect?provider=netflix'); ?></li>
  <?php endif; ?>
</ul>
